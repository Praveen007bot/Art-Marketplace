                                    ...
                                    <table class="table table-hover table-bordered first">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button data-toggle="modal" data-target="#exampleModal" class="btn btn-space btn-primary" onclick="edit_users(<?php echo $res['id'];?>)">Edit</button>
                                                    <button onclick="delete_users(<?php echo $res['id'];?>)" class="btn btn-space btn-danger">DELETE</button>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                        </tbody>
